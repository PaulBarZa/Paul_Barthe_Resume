...
\section{Expériences}
\smallskip
\cventry{Actuellement}{Projet de fin d'étude (6 mois)}{Cytomine}{Liège, Belgique}{}{
    ...
    Technologies utilisées: Python, Java et VueJS.
}
\smallskip
...
\section{Projets}
\smallskip
\cventry{2021}{Classification de sushi}{}{}{}{
    Développement d'un modèle de classification de sushi en 50 types.\\
...
\cvline{Technologies}{MySQL, Android Studio, Echo, React, Symfony, Unity}
...
\cvline{Autres}{Processus de calcul, Électromagnétisme, Physique, Thermodynamique, Mechanique, Anglais (TOEIC 895/990), Espagnol.}
...
\cventry{}{Centres d'intérêt}{}{}{}{
    Intelligence artificielle, Machine learning, Programmation, Course à pied, Natation, Piano.
}
